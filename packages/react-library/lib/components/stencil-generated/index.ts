...
export const PuCard = /*@__PURE__*/createReactComponent<JSX.PuCard, HTMLPuCardElement>('pu-card');
export const PuCheckbox = /*@__PURE__*/createReactComponent<JSX.PuCheckbox, HTMLPuCheckboxElement>('pu-checkbox');
export const PuChip = /*@__PURE__*/createReactComponent<JSX.PuChip, HTMLPuChipElement>('pu-chip');
export const PuDivider = /*@__PURE__*/createReactComponent<JSX.PuDivider, HTMLPuDividerElement>('pu-divider');
export const PuFab = /*@__PURE__*/createReactComponent<JSX.PuFab, HTMLPuFabElement>('pu-fab');
...
export const PuText = /*@__PURE__*/createReactComponent<JSX.PuText, HTMLPuTextElement>('pu-text');
